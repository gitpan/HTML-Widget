...
<form id="widget" method="post"><fieldset><input class="textfield" id="widget_hour" name="hour" type="text" value="6" /><input class="textfield" id="widget_minute" name="minute" type="text" value="12" /><input class="textfield" id="widget_second" name="second" type="text" value="9" /></fieldset></form>
EOF
}
