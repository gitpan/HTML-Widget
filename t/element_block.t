...
# Without query
{
    my $f = $w->process;
    is( "$f", <<EOF, 'XML output' );
<form id="widget" method="post"><div id="widget_foo"><label for="widget_foo_bar" id="widget_foo_bar_label">Bar<input class="textfield" id="widget_foo_bar" name="bar" type="text" value="bar" /></label><fieldset id="widget_foo_fs"><legend id="widget_foo_fs_legend">FS</legend><input class="textfield" id="widget_foo_fs_baz" name="baz" type="text" /></fieldset><fieldset id="widget_foo_fs2"><input class="textfield" id="widget_foo_fs2_bartwo" name="bartwo" type="text" /><input class="textfield" id="widget_foo_fs2_baztwo" name="baztwo" type="text" /><fieldset id="widget_foo_fs2_fsnest"><input class="textfield" id="widget_foo_fs2_fsnest_barnest" name="barnest" type="text" value="Barnest" /></fieldset></fieldset><input class="textfield" id="widget_foo_nc_norp" name="norp" type="text" /></div></form>
EOF
}
...
<form id="widget" method="post"><div id="widget_foo"><label for="widget_foo_bar" id="widget_foo_bar_label">Bar<input class="textfield" id="widget_foo_bar" name="bar" type="text" value="yada" /></label><fieldset id="widget_foo_fs"><legend id="widget_foo_fs_legend">FS</legend><input class="textfield" id="widget_foo_fs_baz" name="baz" type="text" value="23" /></fieldset><fieldset id="widget_foo_fs2"><input class="textfield" id="widget_foo_fs2_bartwo" name="bartwo" type="text" value="ping" /><input class="textfield" id="widget_foo_fs2_baztwo" name="baztwo" type="text" value="18" /><fieldset id="widget_foo_fs2_fsnest"><input class="textfield" id="widget_foo_fs2_fsnest_barnest" name="barnest" type="text" value="yellow" /></fieldset></fieldset><input class="textfield" id="widget_foo_nc_norp" name="norp" type="text" /></div></form>
EOF
}
